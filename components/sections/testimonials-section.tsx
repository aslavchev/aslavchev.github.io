...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
  ...
  return (
    <Card className="relative overflow-hidden hover:shadow-lg transition-shadow w-[340px] sm:w-[380px] flex-shrink-0 snap-start">
...
export function TestimonialsSection() {
  ...
  const scrollNext = () => scrollToTestimonial((activeIndex + 1) % testimonials.length)
  const scrollPrev = () => scrollToTestimonial((activeIndex - 1 + testimonials.length) % testimonials.length)
  ...
  return (
    <section id="testimonials" className="space-y-8">
      ...
      {/* Carousel — bleeds on mobile/tablet, content-width on desktop */}
      <div className="relative -mx-6 sm:-mx-8 lg:mx-0">
        ...
        <div
          ref={scrollRef}
          className="overflow-x-auto px-6 sm:px-8 lg:px-0 pb-4 scrollbar-thin scrollbar-thumb-primary/20 scrollbar-track-transparent snap-x snap-mandatory"
        >
          <div className="flex gap-6 min-w-max lg:w-full lg:justify-center">
            {testimonials.map((t) => (
